...
public class Subscription {
    ...
    //-------------------------------------------------------------------------------------------- +++++
    @TargetApi(26)
    public void subscribeToService(WifiAwareSession wifiAwareSession, byte[] peerId, HashMap<byte[],byte[]> advertisingInfo) {
        ...
        wifiAwareSession.subscribe(config, new DiscoverySessionCallback() {
            ...
            public void onServiceDiscovered(PeerHandle peerHandle, byte[] serviceSpecificInfo, List<byte[]> matchFilter) {
               ...
               // if(!networkBuilt)
                subscribeDiscoverySession.sendMessage(peerHandle,WifiAwareDiscovery.STATUS_MESSAGE,status);
            }
